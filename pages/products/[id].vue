              ...
              <div class="row justify-content-arround g-3 pt-3 mb-3">
                <div class="col-sm-4">
                  <NuxtImg class="img-fluid rounded" :src="product?.image" :alt="`Products ${product?.title}`"
                    loading="lazy" format="webp" :width="300" :height="300" />
                </div>
                <div class="col-sm-8">
...
const formatToRupiah: (price: number | bigint) => string = (price: number | bigint) => {
...
const addIncrementQuantity = () => quantity.value++
const addDecrementQuantity = () => quantity.value--
